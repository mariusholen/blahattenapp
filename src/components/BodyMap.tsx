...
export const BodyMap = ({ answer, onAnswer }: BodyMapProps) => {
	return (
		<div className="relative">
			...
			<svg
				...
				width="300px"
				height="300px"
				viewBox="0 0 208.081 208.081"
				onClick={() => onAnswer("")}
			>
				<path
					d="M140.457,0.394c0,0,7.837-2.476,10.869,4.987c0,0,11.624,12.909,12.891,22.213c0,0,0.481,2.841-2.283,4.375
